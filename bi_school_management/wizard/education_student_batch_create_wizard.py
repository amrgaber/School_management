...
class EducationStudentBatchCreateWizard(models.TransientModel):
    ...
    student_line_ids = fields.One2many('education.student.batch.create.line', 'wizard_id', string='Students')
...
class EducationStudentBatchCreateLine(models.TransientModel):
    ...
    wizard_id = fields.Many2one('education.student.batch.create.wizard', required=True, ondelete='cascade')
